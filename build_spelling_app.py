"""
Build script for Spelling Practice App
...
def build_executable():
    """Build the spelling practice app executable using PyInstaller"""

    print("=" * 60)
    print("Building Spelling Practice App Executable")
    print("=" * 60)
    ...
    # Application details
    app_name = "SpellingPracticeApp"
    script_name = "spelling_practice_app.py"
    ...
    try:
        ...
        print(f"  4. Enter a word to practice")
        print(f"  5. Click 'Start Recording' and speak!")
...
def main():
    """Main entry point"""
    print("\nSpelling Practice App - Build Script")
    print("=" * 60 + "\n")

    # Check if script exists
    if not Path("spelling_practice_app.py").exists():
        print("✗ Error: spelling_practice_app.py not found!")
